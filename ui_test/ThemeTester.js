// /Users/montysharma/Documents/V10/simplified/ui_test/ThemeTester.js
...
const ThemeTester = () => {
  ...
  const handleThemeChange = (themeName) => {
    ...
    toast({
      title: `Theme changed to ${themes[themeName].name}`,
      status: 'success',
      duration: 2000,
      isClosable: true,
    });
  ...
  return (
    <ChakraProvider theme={themes[currentTheme].theme}>
